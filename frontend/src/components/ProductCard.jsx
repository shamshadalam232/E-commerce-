...
<div>
  <div className='grid grid-cols-3 sm:grid-cols-1 md:grid-cols-3 gap-4 p-5'>
     
     <div className='group bg-sky-200 rounded-xl p-4 flex flex-col md:flex-row  justify-center items-center gap-2 md:gap-4 cursor-pointer transition duration-300 hover:-translate-y-1 hover:shadow-md'>
    <div className='bg-white rounded-full p-3 mb-2 transition duration-300 group-hover:scale-110'>
      <Truck size={56} color="#361259" />
    </div>
    <p className='font-medium text-gray-700 text-sm md:text-4xl'>Free Shipping</p>
  ...
  <div className='group bg-sky-200 rounded-xl p-4 flex flex-col md:flex-row  justify-center items-center gap-2 md:gap-4 cursor-pointer transition duration-300 hover:-translate-y-1 hover:shadow-md'>
    ...
    <p className='font-medium text-gray-700 text-sm md:text-4xl'>Easy Returns</p>
  </div>
  ...
  <div className='group bg-sky-200 rounded-xl p-4 flex flex-col md:flex-row  justify-center items-center gap-2 md:gap-4 cursor-pointer transition duration-300 hover:-translate-y-1 hover:shadow-md'>
    ...
    <p className='font-medium text-gray-700 text-sm md:text-4xl'>24/7 Support</p>
  </div>
